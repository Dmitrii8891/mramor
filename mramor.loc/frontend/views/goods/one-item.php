...
?>
    <div class="tovar-mramor-see-wrap">
        ...
        <div class="tovar-mramor-see-text">
            <div class="tovar-mramor-title"><?= $model->stones? $model->stones->name: '' ?> <span><?= $model->name?></span></div>
            <div class="tovar-mramor-see-table" style="margin-top: 20px;">
                <table class="tov-tb-1" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        ...
                        <td height="20"><td><span style="font-size: 13px; font-family: arial; color: #565656; margin-left: 11px;"><?= $model->stones?$model->stones->country->name:''?></span></td>
                    </tr>
                </table>
