    ...
    <div class="portfolio-portfolio-overflow">
        ...
        <div class="portfolio-portfolio-img-wrap">
            <div class="portfolio-portfolio-img">
                <?=  Html::a(Html::img($model['image']),[$model['url'], 'translit' =>$model['translit'] ])  ?>
            </div>
        </div>
        <div class="portfolio-portfolio-text-wrap">
            <div class="portfolio-category-name"><?=  Html::a($model['name'],[$model['url'], 'translit' =>$model['translit'] ])  ?></div>
