    ...
    <div class="portfolio-portfolio-overflow">
        ...
        <div class="portfolio-portfolio-img-wrap">
            <div class="portfolio-portfolio-img">
                <?=  Html::a(Html::img($model->image),['standard-services/view', 'translit' =>$model->translit ])  ?>
            </div>
        </div>
        <div class="portfolio-portfolio-text-wrap">
            <div class="portfolio-category-name"><?=  Html::a($model->name,['standard-services/view', 'translit' =>$model->translit ])  ?></div>
